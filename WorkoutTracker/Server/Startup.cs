...
namespace WorkoutTracker.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configure.Filters.Add(new AuthorizeFilter(userAuthenticationPolicy));
            });
            ...
            services.AddScoped<IMuscleGroupRespository, MuscleGroupRespository>();
